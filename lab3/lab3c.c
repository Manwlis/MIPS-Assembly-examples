    ...
    {
        {
            ...
            printf("11 ektipwsh dieu8unsewn\n");
            printf("12 eksodos\n");
...
void ektipwshDieu8ynsewn()
{
    ...
    printf("4: %d \n",emfanishStoixeiou);
    printf("5: %d \n",emfanishPlh8ous);
    printf("6: %d \n",emfanishDieu8hnshsStoixeiou);
    printf("7: %d \n",ektipwshDieu8hnshsListas);
    printf("8: %d \n",emfanishDieu8hnshsPediouStoixeiou);
    printf("9: %d \n",ektupwshMege8ousListas);
    printf("10: %d \n",ektupwshMege8ousStoixeiou);
    printf("11: %d \n",ektipwshDieu8ynsewn);
}
