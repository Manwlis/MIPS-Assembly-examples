...
int dhmiourgia(int R2);
int eisagwghTelos(int R2,int R3);
int diagrafhTelos(int R2,int R3);
void emfanishStoixeiou(int R2,int R3);
...
int main()
{
    R1 = 0; /*to R1 einai gia thn epilogh*/
    /*R2 einai head R3 einai count*/
    node *head = NULL;
    int count = 0;
